...
<div class="container-fluid text-center">    
  <div class="row content" align="center" style='margin-left:12%;margin-right:1%;'>
    
    <div class="col-sm-12 text-left"  > 
      
		<div class="container" >
		  <h1 align="center">Welcome <?php echo $_SESSION['username'];?> in Customer Massage</h1>
		  <table id="my-example" >
			<thead>
			  <tr>
				  <th>Name</th>
...
<script type="text/javascript">
  $(document).ready(function() {
      $('#my-example').dataTable({
        "bProcessing": true,
        "sAjaxSource": "config/cust_msg.php",
        "aoColumns": [
              { mData: 'name' } ,
              { mData: 'email' },
