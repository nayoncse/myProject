		...
		<div class="fh-container mx-auto">
			<div class="row my-lg-5 mb-5" style=" margin-left:px;">
				...
				<!-- //grid left -->
					...
					$result = [];
			$ch = curl_init();
			$url = $base_url ."/config/women_moreProduct.php";
			$value = "req=product";
                        ...
                        <div class="item" style="width:230px; margin-left:25px; margin-top:20px;" >
                            ...
                            <div class="card product-men p-3">
                                <div class="men-thumb-item">
                                    <img  src="<?php  echo $product->w_pimage; ?>" alt="img" class="card-img-top">
                                ...
                                <div class="card-body  py-3 px-2" >
                                    <h5 class="card-title text-capitalize"><?php  echo $product->w_pname; ?></h5>
                                    <div class="card-text d-flex justify-content-between">
                                        <p class="text-dark font-weight-bold">$<?php  echo $product->w_pnewPrice; ?></p>
                                        <p class="line-through">$<?php  echo $product->w_poldPrice; ?></p>
                                    </div>
                                </div>
                                <!-- card footer -->
                                <div class="card-footer d-flex justify-content-end">
                                    <form action="#" method="post">
                                        ...
                                        <input type="hidden" name="hub_item" value="<?php  echo $product->w_pname; ?>">
                                        <input type="hidden" name="amount" value="<?php  echo $product->w_pnewPrice; ?>">
